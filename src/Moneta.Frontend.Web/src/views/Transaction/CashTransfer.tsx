...
export interface NewCashDeposit {
    id: string
    accountId: string
    date: string
    amount: number,
...
export const CashTransfer = () => {
    ...
    const [cashDeposit, SetCashDeposit] = useState<NewCashDeposit>();
    const onSubmit = async (data:NewCashDeposit) => {
        const request = {
